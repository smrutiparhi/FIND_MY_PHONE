...
export function PoliceReportApprovalActions({
  ...
  if (confirmingApprove) {
    return (
      <div className="rounded-md border border-sky-900 bg-sky-950/40 p-3">
    ...
    return (
      <div className="rounded-md border border-emerald-900 bg-emerald-950/40 p-3">
        ...
        <input
          ...
          maxLength={100}
          className="mt-2 w-full rounded-md border border-slate-700 bg-slate-950 px-2.5 py-1.5 text-xs text-white placeholder:text-slate-600"
        />
        <div className="mt-2 flex gap-2">
          <button
            type="button"
